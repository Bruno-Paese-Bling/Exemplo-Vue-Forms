import {
  ...
  script as script2,
  script2 as script3
} from "./chunk-II72FJXI.js";
import "./chunk-W7257FCB.js";
import {
  UniqueComponentId,
  script
} from "./chunk-Y6VFJSWW.js";
import {
  BaseStyle
} from "./chunk-K2LVXRQO.js";
import {
  Transition,
  createBaseVNode,
  createBlock,
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return [_ctx.header ? (openBlock(), createElementBlock("span", mergeProps({
      ...
      id: $data.id + "_header",
      "class": _ctx.cx("title")
    }, _ctx.ptm("title")), toDisplayString(_ctx.header), 17, _hoisted_13)) : createCommentVNode("", true)];
    ...
    "default": withCtx(function() {
      ...
      }, _ctx.ptm("footer")), [renderSlot(_ctx.$slots, "footer")], 16)) : createCommentVNode("", true)], 16, _hoisted_23), [[vShow, !$data.d_collapsed]])];
    }),
    _: 3
  }, 16)], 16);
}
