import {
  PrimeVueService
} from "./chunk-SB6GO6X2.js";
import {
  Base,
  UniqueComponentId,
  script
} from "./chunk-HY2Z7ASY.js";
import {
  BaseStyle,
  addClass,
  config_default,
...
var _hoisted_14 = ["id"];
var _hoisted_24 = ["id", "aria-labelledby"];
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return [_ctx.header ? (openBlock(), createElementBlock("span", mergeProps({
      ...
      id: $data.id + "_header",
      "class": _ctx.cx("title")
    }, _ctx.ptm("title")), toDisplayString(_ctx.header), 17, _hoisted_14)) : createCommentVNode("", true)];
    ...
    "default": withCtx(function() {
      ...
      }, _ctx.ptm("footer")), [renderSlot(_ctx.$slots, "footer")], 16)) : createCommentVNode("", true)], 16, _hoisted_24), [[vShow, !$data.d_collapsed]])];
    }),
    _: 3
  }, 16)], 16);
}
